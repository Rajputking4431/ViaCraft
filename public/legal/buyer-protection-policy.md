...
1.  **Contact Vendor:** Contact the Vendor directly via the Dashboard messaging tool.
2.  **Escalate:** If the issue is not resolved within 48 hours, contact ViaCraft support at support@viacraft.in.
3.  **Mediation:** The Platform support team will review visual evidence (unboxing video/photos) and mediate.
4.  **Refund/Replacement:** If the claim is valid, the Platform will issue a refund or require the Vendor to ship a replacement.
