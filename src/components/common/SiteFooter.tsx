...
export function SiteFooter() {
  ...
  const cols: {
    ...
    links: {
      ...
      },
      {
        title: "Social",
        links: [
          { label: "Instagram", to: "https://www.instagram.com/viacraft.in?igsh=aTF4cGh3YW5xcGlk", isExternal: true, icon: Instagram },
          { label: "Facebook", to: "https://www.facebook.com/share/1EHuub7TV8/", isExternal: true, icon: Facebook },
  ...
  const contactInfo = {
    ...
    phone: "+91 73833 53968",
    hours: "Monday–Saturday, 10 AM – 7 PM",
    address: "ViaCraft Office, Amrajinagar Bhargavroad kubernagar, Ahmedabad, Gujarat - 382340, India",
  };
          ...
          return (
            <div key={c.title} className="border-b border-border/40 lg:border-b-0 pb-4 lg:pb-0">
              <button
                ...
                aria-expanded={expandedCols[c.title] ? "true" : "false"}
                aria-label={`Toggle ${c.title} navigation section`}
              >
                <span>{c.title}</span>
                <ChevronDown
              ...
              <ul
                className={`space-y-2.5 text-sm text-muted-foreground transition-all duration-300 overflow-hidden ${isExpanded
